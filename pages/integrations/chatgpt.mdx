...
If ChatGPT MCP is unavailable, use the [CloudAgent Assistant](/guide/automation/assistant) in our web dashboard for the same natural language experience.

## Next Steps

- [CloudAgent Assistant](/guide/automation/assistant) — web-based AI interface
