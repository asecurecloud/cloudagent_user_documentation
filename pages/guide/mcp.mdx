...
- A CloudAgent account with at least one [connected AWS environment](/guide/cloud-setup/aws)
...
2. Navigate to **Setup** → **MCP Extension** in the sidebar.
...
- **[Blueprints & Agents](/guide/automation/blueprints)**: Create reusable infrastructure templates for your team.
- **[Managing Workloads](/guide/workloads-governance/workloads)**: Configure security baselines and governance rules.
