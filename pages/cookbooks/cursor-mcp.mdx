...
1. Get your MCP configuration from CloudAgent (**Setup** → **MCP Extension**).
2. Open Cursor IDE → **Settings** → **MCP Config**.
3. Paste the configuration and restart Cursor.
4. Authenticate via OAuth when prompted on first use.
5. Start building!
...
- **[Managing Workloads](/guide/workloads-governance/workloads)**: Configure security baselines and governance
- **[CloudAgent Assistant](/guide/automation/assistant)**: Use AI for cloud operations in the web UI
